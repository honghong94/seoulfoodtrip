...
<body>
    <h2>서울푸드트립 서비스 이용약관</h2>
    <br>

    <h3>제 1 장 총 칙</h3>
    <h4>제1조 목적</h4>
    이 약관은 서울푸드트립 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.<br>
    <br>
    <h4>제2조 용어의 정의</h4>
    ...
    - '회사','서비스제공자'란 ' 서울푸드트립과 계약된 별도서비스 운영자를 뜻합니다.<br>
    ...
    단, 이 경우 '회원'은 언제든지 문의 게시판 또는 문의메일(seoul-food-trip@mail.com)을 통해 해당 '게시물'대해 삭제, 비공개 등의 요청을 할 수 있습니다.<br>
    ...
    (2) '서비스제공자'와 '회원'간 발생한 분쟁에 관한 소송은 '서비스제공자'의 소재지의 관할 법원에 제소합니다.<br>
    <br><br>
    부 칙<br>
    본 약관은 2012년 1월 19일부터 적용됩니다.<br>
    <br><br>
    부 칙<br>
    본 약관은 2018년 1월 19일부터 적용됩니다.<br>
    <br><br>
    부 칙<br>
    본 약관은 2024년 1월 19일 수정되었습니다.<br>
    수정사항은 2024년 1월 19일부터 시행됩니다.<br>
</body>
</html>
